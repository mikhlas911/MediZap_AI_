/*
  ...
  1. Changes
    - Update create_clinic_with_admin function to include clinicname column
    - Ensure both name and clinicname are populated from clinic_name parameter
...
BEGIN
  ...
  -- Create the clinic (include both name and clinicname columns)
